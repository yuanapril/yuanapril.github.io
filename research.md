  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        ...
        <span class="tldr-preview">A VLM-based reasoning framework that elevates video anomaly detection from pattern matching to</span>
      </summary>
      <div class="tldr-full">
...
<div class="publication-item">
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">A reasoning-centric framework that repurposes LLMs for time series forecasting.</span>
      </summary>
      <div class="tldr-full">
...
<div class="publication-item">
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">An interactive text-vision-audio pronunciation coaching system combining LLM-powered assessment, Neural TTS</span>
      </summary>
      <div class="tldr-full">
...
<div class="publication-item">
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">A novel approach for long-term time-series forecasting through Prefix Reprogramming with noise-based prefixes</span>
      </summary>
      <div class="tldr-full">
...
<div class="publication-item">
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">A non-autoregressive DiffusionLM-based storytelling model that generates coherent narratives around visual</span>
      </summary>
      <div class="tldr-full">
...
<div class="publication-item">
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">A robust person re-identification method addressing occlusion challenges through dual-branch Vision Transformer</span>
      </summary>
      <div class="tldr-full">
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">An interactive text-vision-audio pronunciation coaching system combining LLM-powered assessment, Neural TTS</span>
        <span class="tldr-full-text">An interactive text-vision-audio pronunciation coaching system combining LLM-powered assessment, Neural TTS exemplars, and viseme animations. Validated with 82 students showing 90%+ satisfaction, the system was adopted as an intelligent teaching assistant in a graduate-level English course at Peking University.</span>
      </summary>
    </details>
  </div>
</div>
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">A non-autoregressive DiffusionLM-based storytelling model that generates coherent narratives around visual</span>
        <span class="tldr-full-text">A non-autoregressive DiffusionLM-based storytelling model that generates coherent narratives around visual sequences. Trained with weighted conditions on global vision-language history, DiffuVST achieves superior performance with 10× faster inference than autoregressive models.</span>
      </summary>
    </details>
  </div>
</div>
  ...
  <div class="pub-content">
    ...
    <details class="pub-tldr-collapsible">
      <summary>
        <span class="tldr-label">TL;DR:</span>
        <span class="tldr-preview">A robust person re-identification method addressing occlusion challenges through dual-branch Vision Transformer</span>
        <span class="tldr-full-text">A robust person re-identification method addressing occlusion challenges through dual-branch Vision Transformer with jigsaw patch modules and innovative ranking optimization. Achieved 98.38% mAP and 99.57% rank-1 accuracy, winning second place in the DeepSportRadar Player REID Challenge.</span>
      </summary>
    </details>
  </div>
</div>
